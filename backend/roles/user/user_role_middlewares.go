...
func CheckInsults(input string) bool {
	insults := []string{"fuck", "fuck off", "mother fucker", "bitch", "bastard", "suck", "suck my dick", "fuck you", "fuck your mother"}
...
func FilterInsults2(input string) string {
	insults := []string{"fuck", "fuck off", "mother fucker", "bitch", "bastard", "suck", "suck my dick", "fuck you", "fuck your mother", "shit"}
